    ...
    return (
        <div className="bg-white  ">
            <div className="mx-auto ">
                ...
                <div className="mt-6 mb-12 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-20 ">
                    {products.map(product => (
                        <ProductCard
                            key={product.id}
                            id={product.id}
                            image={product.images?.[0]?.src || defaultImageSrc}
                            name={product.name}
                            price={product.price}
                            describtion={product.description}
                            category={product.category || 'велотовари'}
                        />
                    ))}
                </div>
                    ...
                    <PaginationContent>
                        ...
                        <PaginationItem>
                            <PaginationNext
                                onClick={() =>
                                    setCurrentPage(prev =>
                                        Math.min(Math.ceil(totalProducts / 12), prev + 1)
                                    )
                                }
