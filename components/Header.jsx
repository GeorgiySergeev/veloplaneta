    ...
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200 py-4">
      <div className="container mx-auto ">
        <div className="flex flex-col  justify-between">
         ...
         <Link href="/" className="text-2xl hidden lg:block font-bold text-blue-900 font-inter">
              ...
              <div
                ...
                <div className="grid grid-cols-4 gap-6 px-6">
                  ...
                  <div className="col-span-1 bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">Популярні категорії</h3>
                    <ul className="space-y-2">
                      <li>
                        <Link href="/bikes/new" className="text-gray-600 hover:text-gray-900">
                          Нові надходження
                        </Link>
                      </li>
                      <li>
                        <Link href="/bikes/sale" className="text-gray-600 hover:text-gray-900">
                          Акційні пропозиції
                        </Link>
                      </li>
                      <li>
                        <Link href="/bikes/premium" className="text-gray-600 hover:text-gray-900">
                          Преміум клас
                        </Link>
                      </li>
                    </ul>
