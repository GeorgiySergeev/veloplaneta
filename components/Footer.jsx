...
export default function Footer() {
  const categories = [
    ...
    { name: 'Вело запчастини', subcategories: ['Трансмісія', 'Гальма', 'Колеса', 'Компоненти'] },
    ...
    <footer className=" border-t border-gray-800 pt-12 pb-8">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold text-blue mb-4">VELOPLANETA</h3>
            <p className="text-gray-400 mb-4">
              Ваш надійний партнер у світі велоспорту. Продаж та обслуговування велосипедів з 2010
              року.
            </p>
